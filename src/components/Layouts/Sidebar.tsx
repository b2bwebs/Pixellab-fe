            ...
            >
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center gap-3">
                            <img className="w-8 ml-[5px] flex-none" src="/assets/images/favicon.png" alt="logo" />
                            <span className="text-2xl font-semibold align-middle dark:text-white-light pt-1">
                                PixelLab
                            </span>
                        </NavLink>
